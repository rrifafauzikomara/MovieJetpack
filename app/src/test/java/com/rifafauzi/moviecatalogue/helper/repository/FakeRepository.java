...
public class FakeRepository implements DataSource {
    ...
    public static FakeRepository getInstance(RemoteDataSource remoteDataSource, LocalDataSource localDataSource, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (FakeRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeRepository(remoteDataSource, localDataSource, appExecutors);
                }
            }
        }
        return INSTANCE;
